...
class ObservedRain:
    ...
    def create_library(self,
        ...
        Args:
            ...
            block_size: duration of blocks that will be later randomly collated to generate synthetic rain
        ...
        rain = self.data.copy()
        rain[group_column] = rain.index.map(
            lambda x: x.year if (x.month < year_start) | (year_start == 1) else x.year + 1)
